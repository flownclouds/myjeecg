package com.buss.geninfo.entity;
 ...
 */
@Entity
@Table(name = "gen_config", schema = "")
@SuppressWarnings("serial")
public class GenConfigEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="TYPEINFO",nullable=false,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  键信息
	 */
	@Column(name ="KEYINFO",nullable=false,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  值信息
	 */
	@Column(name ="VALUEINFO",nullable=false,length=3000 )
