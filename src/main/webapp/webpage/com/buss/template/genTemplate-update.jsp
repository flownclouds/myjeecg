...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="genTemplateController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="templateName" name="templateName" type="text" style="width: 150px" class="inputxt" datatype="*" value='${genTemplatePage.templateName}'>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="genTemplateController.do?genTemplateFilesList&id=${genTemplatePage.id}&load=${loadtag}&ispermit=${isPermit}" icon="icon-search" title="模板文件" id="genTemplateFiles"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
